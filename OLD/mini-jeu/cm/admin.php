                ...
                while($data = $req -> fetch()){
                    ...
                    <div class="mPost '.$certif.'">
                        <div class="mPostHead">
                            ...
                            <h2>'.$data['pseudo'].$check.'<div class="menuControl"><img class="delete" id="'.$data['id'].'" src="images/delete.svg"><img id="'.$data['id'].'" data-certif="'.$data['certif'].'" src="images/check.svg"/></div><h2>
                        </div>
                        <p>'.$data['textMsg'].'</p>
                    </div>
                    ');
