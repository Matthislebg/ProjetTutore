...
<head>
    ...
    <link href="../styles/jeu_dev.css" rel="stylesheet">
    <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script src="../scripts/jeu_dev.js"></script>
...
<body>
    <div class="dev">
        <!-- <h1>Devenez notre dev Front-end !</h1> -->
        <!-- <div></div> -->
        <!-- <p>changez le css de cette page à votre guise</p> -->
    <div class="jeuDev">
        <div class="code">
            <div>
        ...
        <div class="outils">
            ...
            <details class="custom-select">
                <summary class="radios">
                    ...
                    <input type="radio" name="item" id="img" title="img">
            ...
            <div>
            <h2>height</h2>
            <input type="range" id="heightS" min="25" max="45" value="35">
            </div>
            <div>
            <h2>color</h2>
            <input type="color" id="colorS" value="#EEB81D">
            </div>
            <div>
            ...
            <div>
            <h2>margin-bottom</h2>
            <input type="range" id="mBottomS" min="0" max="45" value="0">
            </div>
        </div>
    </div>
</div>
